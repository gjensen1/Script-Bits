...
Get-View -ViewType HostSystem | Select Name,@{N="Serial";E={$_.Summary.Hardware.OtherIdentifyingInfo[3].IdentifierValue}}


Get-View -ViewType Hostsystem -filter @{"Name"="itspals7esx001.cihs.gov.on.ca"} | Select Name,@{N="Vendor";E={$_.Hardware.systemInfo.Vendor}},@{N="Model";e={$_.Hardware.SystemInfo.Model}},@{Name="Serial#"; E={($_.Hardware.SystemInfo.OtherIdentifyingInfo | Where {$_.IdentifierType.Key -eq "ServiceTag"}).IdentifierValue}}
