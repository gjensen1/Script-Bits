...
Connect-VIServer ctsbigdcapmdw79.cihs.ad.gov.on.ca

#Get list of ESXi Hosts
$esxihosts = Get-VMHost -Name ctspigdcvhisabz.mgmt.cihs.gov.on.ca
$i=0
...
$data | Export-Csv -NoTypeInformation 'c:\temp\ESXiStorageInfo.csv'